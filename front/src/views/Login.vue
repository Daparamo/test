<template>
  ...
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form>
      <input type="text" id="login" class="fadeIn second" name="login" placeholder="login" v-model="form.email">
...
export default {
  ...
  methods: {
    setup() {
      this.form.email = this.ref("lol@lol.com");
      this.form.password = this.ref("lol");
    },
    login() {
